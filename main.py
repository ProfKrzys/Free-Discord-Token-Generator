# Leaked by Sovle/internalvpn
# GitHub.com/internalvpn
# fraud.lol/solve
# dxnii is retarded and is a skid 😭, stop scamming lil nigga
...
class Title:
    ...
    def update_title(self):
            try:
                ...
                title = f'Switch G | G: {genned} | E: {errors} | S: {solved} | U: {unlocked} | L: {locked} | Unlock Rate: {unlock_rate}% | Elapsed: {round(time() - genStartTime, 2)}s |'
     ...
     GitHub.com/internalvpn          ╚██████║╚██████║╚██████║    ██║  ███╗█████╗  ██╔██╗ ██║
       fraud.lol/solve                ╚═══██║ ╚═══██║ ╚═══██║    ██║   ██║██╔══╝  ██║╚██╗██║
                                      ...
                                      ╚════╝  ╚════╝  ╚════╝      ╚═════╝ ╚══════╝╚═╝  ╚═══╝
                                                ...
                                                discord.gg/999shops
    ''')
    threads = int(input(Fore.LIGHTMAGENTA_EX + "Threadcount: " + Fore.RESET))
